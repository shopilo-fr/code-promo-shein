#!/usr/bin/env python3
"""
Recuperation des codes promo SHEIN depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/shein.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/shein.com"
STORE_NAME = "SHEIN"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour SHEIN depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-shein)"
    }
    try:
